...
Reads from /tmp/artifacts/ph-results-*/results.json
...
def send_summary_email(new_count: int, total: int, timestamp: str):
    ...
    subject  = f"Children's & Pediatric Health Research Digest — {run_date} | {new_count} {'Study' if new_count == 1 else 'Studies'}"
    html = f"""<!DOCTYPE html>
<html>
